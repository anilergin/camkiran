	...
	<div class="entry-content-wrap">
		...
		<div class="entry-content-inner">
			...
			<div class="entry-excerpt text-color-light">
				<?php echo g5plus_string_limit_words(get_the_excerpt(), 15);?>&hellip;<a class="text-color-accent" title="<?php the_title(); ?>" href="<?php echo get_permalink(); ?>"><?php esc_html_e('Daha Fazla','g5plus-orson') ?></a>
			</div>
		</div>
	</div>
</article>
