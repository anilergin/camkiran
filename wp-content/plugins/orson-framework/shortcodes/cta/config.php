...
return array(
	...
	'params' => array(
		...
		array(
			...
			'admin_label' => true,
			'group' => esc_html__('Button','g5plus-orson')
		),
		...
		array_merge(g5plus_vc_map_add_icon_font($dependency_add_icon),array('param_name' => 'button_icon_font','group' => esc_html__('Button','g5plus-orson'))),
